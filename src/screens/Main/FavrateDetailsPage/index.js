...
const MyProducts = () => {
  ...
  const selector = useSelector(
    state => state.categoryDetailData1.RetailerFavProduct,
  );
                  ...
                  <View
                    ...
                    <View
                      style={{
                        ...
                        marginTop: Platform.OS == 'android' ? -37 : -50,
                        alignSelf: 'flex-end',
                        height: hp('2.4%'),
                        width: '45%', // paddingVertical: 3
                      }}>
                      <Text
                        style={
                          styles.cardview2text
                        }>{`${item.ProductDetails?.Weight} GM`}</Text>
                    </View>
                  </View>
                  <TouchableOpacity
                    ...
                    {item.ProductDetails?.ProductImageList.map(item1 => (
                      <Image
                        ...
                        source={{
                          uri: `${
                            ImagePath.Path
                          }${item1?.ImageLocation?.substring(1)}`,
                        }}
                      />
                    ))}
                  </TouchableOpacity>
